...
המערכת שולחת לרב, 30 שעות לפני כל אירוע יהודי (שבת/חג/צום/יום לאומי), בשני ערוצים מקבילים:

**📧 Email (ערוץ ראשי, אמין 100%)** — מייל יפה עם:
- תמונה אמנותית מוטמעת
- כותרת + טיזר + קישור קצר + ברכה
- **קופסת טקסט מוכן להעתקה** בתחתית — לחיצה ארוכה → "בחר הכל" → הדבק בוואטסאפ

**💬 WhatsApp (ערוץ משני, best-effort)** — דרך CallMeBot (חינמי):
- אם הבוט עובד באותו רגע — מקבל גם בוואטסאפ ישירות עם התמונה
- אם הבוט לא מגיב — לא נורא, יש לך את המייל

תוכן ההודעה זהה בשני הערוצים. אם CallMeBot לא יציב, המייל תמיד יעבוד.
