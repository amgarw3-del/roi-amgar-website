...
export default function LectureCard({ title, summary, flyer }: LectureCardProps) {
  const flyerUrl = urlFor(flyer).width(800).height(1067).url();
  ...
  return (
    <div className="card overflow-hidden flex flex-col">
      ...
      <div className="p-5 flex flex-col flex-1">
        <h3 className="font-bold text-lg mb-2 leading-snug" style={{ color: "var(--color-navy)" }}>
          {title}
        </h3>
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 rounded-lg py-2.5 px-4 text-sm font-semibold transition-colors"
