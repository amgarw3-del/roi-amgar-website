...
export default function WhatsAppFloatingButton() {
  ...
  return (
    <a
      ...
      aria-label={label}
      className="fixed bottom-24 md:bottom-6 right-4 md:right-6 z-40 flex items-center justify-center rounded-full shadow-lg hover:scale-110 transition-transform"
      style={{
        background: "#25D366",
        width: "56px",
        height: "56px",
